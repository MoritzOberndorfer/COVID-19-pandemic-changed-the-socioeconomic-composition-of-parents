...
Code for Editor's suggestion to leave out 2019 data and re-estimate
Doing it for all figures in main manuscript
...
drop if year ==2019 // EDITOR's REQUEST
*------------------------------------------
...
graph save "$graph/without2019_top_number_all$S_DATE.gph", replace
graph export "$graph/without2019_top_number_all$S_DATE.svg", replace height(3000) width(3000)
...
graph save "$graph/without2019_bot_number_all$S_DATE.gph", replace
graph export "$graph/without2019_bot_number_all$S_DATE.svg", replace height(3000) width(3000)
...
graph export "$graph/without2019_top_bot_forest_$S_DATE.svg" ,replace
...
graph export "$graph/without2019_Composition_all$S_DATE.svg", replace height(2800) width(3000)
...
export excel using "C:\Users\moritzob\OneDrive - University of Helsinki\postdoc life helsinki\LoCo-effect\International exchangeability paper\Comparative tables\without2019_Main_SEC_Comp_table_all_uncert_$S_DATE.csv", replace firstrow(variables)
