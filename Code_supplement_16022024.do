...
label values area_deprivation_10 deplab10
...
legend(off) ///
yt("", ) ///
ylab(1 "Basic" 2 "      Upper Secondary" 3 "Bachelor's Degree" 4 "Master's Degree") /// 13 characters without spaces
xlab(-0.03 (0.01) 0.03) ///
xt("Absolute Difference in the Proportion of Live Births between Observed vs. Counterfactual Composition") ///
xline(0) ///
...
grc1leg2 AT BRA COL ECU FI MEX NET SCOT ESP US  , ///
col(3)  ///
plotregion(margin(zero)) imargin(zero) ///
xtob1title  ///
...
grc1leg2 AT BRA COL ECU FI MEX NET  ESP US  , ///
col(3)  ///
plotregion(margin(zero)) imargin(zero) ///
xtob1title  ///
